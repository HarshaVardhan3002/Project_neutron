 ...
 * This component demonstrates the layout for video lessons, text content, and a knowledge check quiz.
 */
'use client';
 ...
 * In a real application, this would be fetched from a database based on the lesson ID.
 */
const lessonData = {
